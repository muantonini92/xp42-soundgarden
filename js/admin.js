...
const renderElements = (eventsArray) => {
    eventsArray.forEach( (event, index) => {
        ...
        const tableBodySelector = document.querySelector('#body-table')
        const trElement = document.createElement('tr');
        const thElement = document.createElement('th');
        thElement.innerText = index + 1;
        ...
        dateTdElement.innerText = date + " " + time;

        const eventnameTdElement = document.createElement('td');
        eventnameTdElement.innerText = event.name;

        const attractionsTdElement = document.createElement('td');
        attractionsTdElement.innerText = event.attractions.join(', ');
        ...
        secondAnchorTag.href = `editar-evento.html?id=${event._id}`;
        ...
        actionsTdElement.append(firstAnchorTag, secondAnchorTag, thirdAnchorTag);

        trElement.append(thElement, dateTdElement, eventnameTdElement, attractionsTdElement, actionsTdElement);
